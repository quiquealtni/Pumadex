...
public class EntrenadorControlador {
    ...
    public String vistaEntrenadores(Model model) {
        model.addAttribute("entrenadores",usuarioRepositorio.findAllByRol(Rol.ROLE_ENTRENADOR.toString()));
        model.addAttribute("disciplinas", disciplinaRepositorio.findAll());
        return "vista-entrenadores";
    }
